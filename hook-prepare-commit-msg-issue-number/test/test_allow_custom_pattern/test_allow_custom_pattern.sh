...
ISSUE_NUMBER='A1B1C1'
ISSUE_PATTERN='([A-Z][0-9]){3}'
BRANCH_NAME="qsdf-df-q-d-${ISSUE_NUMBER}"'-additional-issue-description'
...
info "Configuring pattern"
git config issue.pattern "${ISSUE_PATTERN}"
